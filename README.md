...
| [ssh-vid-mover](https://github.com/BleedingCodes/ssh-vid-mover) | [README](https://github.com/BleedingCodes/ssh-vid-mover/blob/main/README.md) | SSH script to pull camera recordings from a remote Linux machine — safe .part download, size verification, remote delete on success |
